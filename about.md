...
<p>My Undergraduate Final Project was focused on discrete time linear stochastic processes, and we showed when to expect the gaussianization of the limit distribution, based on the absolute values of the system's eigenvectors.</p>
</details>
